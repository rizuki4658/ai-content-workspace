...
export default function ContentsArchived({ open, item, onCancel, onConfirm }: {
  open: boolean;
      ...
      <DialogContent
        ...
        <form
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            <p className="text-muted-foreground text-center w-full">This will move "<b>{item?.title}</b>" to the archive list. You can restore it to your active workspace at any time.</p>
            {/* Status */}
            <Controller
              name="status"
              control={control}
